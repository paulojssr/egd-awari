...
class Covid19DataDownloadFromSourceOperator(BaseOperator):
    ...
    def execute(self, context):
        for file_name in files_to_download:
            ...
            # Substituir a URL do GitHub pela URL raw
            raw_file_url = file_url.replace("https://github.com", "https://raw.githubusercontent.com").replace("/blob", "")

            # ***************************************
            # Download para diretorio local e envio para o MinIO            
            self.download_file(raw_file_url)

            # ***************************************
            # Salvando em formato .parquet no datalake
            self.process_to_parquet(raw_file_url)
